...
void LjhnController::constructLeftLeg()
{
	...
	// double L_1xx    =    1.041042671815461e-17;
	// double L_1xy    =    1.154136373000317e-16;
	// double L_1xz    =    1.0588378555322078e-17;
	// double L_1yy    =    -1.836742913879972e-17;
	// double L_1yz    =    0.0;
	// double L_1zz    =    0.061209859466251;
	// double l_1x    =    -7.153031424992761e-17;
	// double l_1y    =    1.3813585749206542e-17;
	// double l_1z    =    8.820466257072331e-17;
	// double m_1    =    0.0;
	// double L_2xx    =    -0.042019267343897396;
	// double L_2xy    =    0.019501160819667268;
	// double L_2xz    =    -0.0047162650218339;
	// double L_2yy    =    0.10322912681014869;
	// double L_2yz    =    0.03160824647938161;
	// double L_2zz    =    0.23376366906191187;
	// double l_2x    =    1.2903494741740777;
	// double l_2y    =    -0.19387165166631126;
	// double l_2z    =    -0.00305559618455525;
	// double m_2    =    3.813384038324244e-05;
	// double L_3xx    =    -0.06059597238549435;
	// double L_3xy    =    -0.06494297628224116;
	// double L_3xz    =    0.111674552374705;
	// double L_3yy    =    0.2523403741035086;
	// double L_3yz    =    -0.0011552761051740856;
	// double L_3zz    =    0.3887683294540634;
	// double l_3x    =    1.6950037328808192;
	// double l_3y    =    0.009360534568960343;
	// double l_3z    =    0.22569818890376284;
	// double m_3    =    0.18291783937341297;
	// double L_4xx    =    0.09565231182427188;
	// double L_4xy    =    0.017077023881352744;
	// double L_4xz    =    -0.05750029340413687;
	// double L_4yy    =    0.09609208989374234;
	// double L_4yz    =    0.0006944683549034301;
	// double L_4zz    =    0.058755822158085474;
	// double l_4x    =    0.5312385523335481;
	// double l_4y    =    -0.017463147616754934;
	// double l_4z    =    -0.19220810739211255;
	// double m_4    =    0.7488899867302038;
	// double L_5xx    =    0.09011665576253042;
	// double L_5xy    =    0.0019749865375321323;
	// double L_5xz    =    -0.00017466159292474;
	// double L_5yy    =    0.10162774595548389;
	// double L_5yz    =    -2.6549778569206626e-05;
	// double L_5zz    =    -0.024200176827755118;
	// double l_5x    =    -1.0470603286155651e-08;
	// double l_5y    =    -0.037232645762955756;
	// double l_5z    =    -0.17496434440314587;
	// double m_5    =    0.92212921018564;
	// double L_6xx    =    0.03134788318081108;
	// double L_6xy    =    0.00014558091012143684;
	// double L_6xz    =    0.0033555629087683703;
	// double L_6yy    =    0.03456859575396422;
	// double L_6yz    =    0.001881230170146934;
	// double L_6zz    =    0.013133762954632627;
	// double l_6x    =    -0.09549048915832026;
	// double l_6y    =    0.0003343978070882374;
	// double l_6z    =    0.037232645762955756;
	// double m_6    =    0.92212921018564;
	...
	double L_1xx    =    2.0820610252285513e-17;
	double L_1xy    =    1.0736635500020309e-16;
	double L_1xz    =    1.0877518402727315e-17;
	double L_1yy    =    -1.8474178180471754e-17;
	double L_1yz    =    0.0;
	double L_1zz    =    0.06164999611831876;
	double l_1x    =    -7.205387526241845e-17;
	double l_1y    =    1.3710722018894144e-17;
	double l_1z    =    8.628035923884042e-17;
	double m_1    =    0.0;
	double L_2xx    =    -0.03432231575450926;
	double L_2xy    =    0.011090754659194353;
	double L_2xz    =    0.018594304587463053;
	double L_2yy    =    0.09597231187282831;
	double L_2yz    =    -0.01949519854837213;
	double L_2zz    =    0.20196471673139907;
	double l_2x    =    1.2696519682296525;
	double l_2y    =    -0.18792071774381294;
	double l_2z    =    -0.0030775678062264734;
	double m_2    =    3.8408046221699105e-05;
	double L_3xx    =    -0.060543254579139644;
	double L_3xy    =    -0.010090065578403437;
	double L_3xz    =    0.06694218532609786;
	double L_3yy    =    0.2281856555560292;
	double L_3yz    =    0.0017402627348290453;
	double L_3zz    =    0.3927128801045153;
	double l_3x    =    1.7074460289175162;
	double l_3y    =    -0.013205245082161015;
	double l_3z    =    0.21500115643294293;
	double m_3    =    0.1790391448725267;
	double L_4xx    =    0.057050387917822576;
	double L_4xy    =    0.015204369012289597;
	double L_4xz    =    -0.03903982252442409;
	double L_4yy    =    0.11059201305906707;
	double L_4yz    =    -0.0011284164306846428;
	double L_4zz    =    0.061206133193647344;
	double l_4x    =    0.527401790135269;
	double l_4y    =    -0.0033256399345509154;
	double l_4z    =    -0.19492586447549953;
	double m_4    =    0.7469250309035682;
	double L_5xx    =    0.07840880270456885;
	double L_5xy    =    0.0017472180527645478;
	double L_5xz    =    -0.002248596571773948;
	double L_5yy    =    0.08923359827232066;
	double L_5yz    =    0.000430194164189615;
	double L_5zz    =    -0.017682156420538553;
	double l_5x    =    -9.898993136289056e-05;
	double l_5y    =    -0.03822688555767527;
	double l_5z    =    -0.18321821209864989;
	double m_5    =    0.9205380503110829;
	double L_6xx    =    0.029602388743445736;
	double L_6xy    =    0.0008790287991571635;
	double L_6xz    =    0.004493511490042265;
	double L_6yy    =    0.03112425754058462;
	double L_6yz    =    0.0004791593888595183;
	double L_6zz    =    0.013563466320674523;
	double l_6x    =    -0.09510594739452638;
	double l_6y    =    0.0004057371966538158;
	double l_6z    =    0.03822688555767527;
	double m_6    =    0.9205380503110829;
